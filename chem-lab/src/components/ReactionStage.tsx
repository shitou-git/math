...
import { RotateCcw, Bookmark, Check, Beaker, FlaskConical, X } from "lucide-react";
              ...
              return (
                ...
                >
                  ...
                  <button
                    ...
                    disabled={isSaved}
                    className={cn(
                      "mt-auto flex items-center justify-center gap-2 rounded-lg px-3 py-2 text-sm font-semibold transition",
                      isSaved
