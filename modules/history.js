...
const HISTORY_DYNASTIES = [
    ...
    },
    {
        ...
        events: [
            ...
            { date: "前9世纪", title: "厉王专利", desc: "周厉王实行"专利"，引起国人不满" },
            { date: "前841年", title: "国人暴动", desc: "国人暴动，厉王出奔，召公、周公二相行政，号曰"共和"，中国历史始有准确年代" },
    ...
    },
    {
        ...
        events: [
            ...
            { date: "前594年", title: "初税亩", desc: "鲁国实行"初税亩"，标志井田制开始瓦解" },
    ...
    },
    {
        ...
        events: [
            ...
            { date: "8年", title: "王莽代汉", desc: "王莽即真天子位，定国号曰"新"，西汉灭亡" },
        ],
    },
    {
        id: "donghan",
    ...
    },
    {
        ...
        events: [
            ...
            { date: "1449年", title: "土木之变", desc: "英宗被瓦剌军所俘，史称"土木之变"" },
    ...
    },
    {
        ...
        events: [
            ...
            { date: "1856年", title: "第二次鸦片战争", desc: "英国借口"亚罗号事件"，挑起第二次鸦片战争" },
    ...
    },
    {
        ...
        events: [
            ...
            { date: "1931年", title: "九一八事变", desc: "日本在沈阳制造"九一八"事变" },
            ...
            { date: "1953年", title: "第一个五年计划", desc: "开始执行发展国民经济的第一个五年计划" },
            { date: "1965年", title: "人工合成胰岛素", desc: "中国人工合成结晶牛胰岛素，世界首次" },
            { date: "1978年", title: "改革开放", desc: "十一届三中全会，开启改革开放新时代" },
            { date: "1984年", title: "奥运金牌零突破", desc: "洛杉矶奥运会中国获15枚金牌" },
            { date: "1990年", title: "北京亚运会", desc: "第11届亚运会在北京举行" },
            { date: "1997年", title: "香港回归", desc: "7月1日，中国对香港恢复行使主权" },
            { date: "1999年", title: "澳门回归", desc: "12月20日，中国对澳门恢复行使主权" },
            { date: "2001年", title: "加入世贸", desc: "WTO多哈会议批准中国入世" },
            { date: "2008年", title: "北京奥运会", desc: "8月，北京成功举办第29届奥运会" },
